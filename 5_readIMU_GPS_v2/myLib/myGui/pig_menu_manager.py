...
class pig_menu_manager:
    ...
    def action_list(self):
        ...
        self.pig_allan_action = QAction("Allan Deviation")
        self.pig_allan_action.setShortcut("Ctrl+A")
        self.pig_plot_action = QAction("Plot Timing Data")
